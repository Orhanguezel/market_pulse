...
-- ----------------------------------------------------------------
(UUID(), 'ui_admin_config', '*', '{"branding":{"app_name":"MarketPulse Admin","app_copyright":"MarketPulse","html_lang":"tr","theme_color":"#E8A598","favicon_16":"/favicon/favicon.png","favicon_32":"/favicon/favicon.png","favicon_url":"/favicon.ico","logo_url":"","apple_touch_icon":"/favicon/apple-touch-icon.png","admin_login_quote":"Pazar istihbaratı ve bayi izleme platformunu buradan yönetin.","admin_login_heading":"","admin_login_background_url":"/img/admin_login_bg.png","meta":{"title":"MarketPulse Admin","description":"Pazar istihbaratı yönetim paneli.","og_url":"","og_title":"MarketPulse Admin","og_description":"Bayi, lead ve rakip izleme yönetim paneli.","og_image":"/favicon/apple-touch-icon.png","twitter_card":"summary_large_image"}}}');
