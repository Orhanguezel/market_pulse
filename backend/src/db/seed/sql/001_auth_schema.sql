...
CREATE TABLE IF NOT EXISTS profiles (
  ...
  sender_smtp_host VARCHAR(255) DEFAULT NULL,
  sender_smtp_port INT         DEFAULT NULL,
  sender_smtp_username VARCHAR(255) DEFAULT NULL,
  sender_smtp_password TEXT    DEFAULT NULL,
  sender_smtp_secure TINYINT(1) DEFAULT NULL,
  created_at     DATETIME(3)   NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  updated_at     DATETIME(3)   NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
  PRIMARY KEY (id),
