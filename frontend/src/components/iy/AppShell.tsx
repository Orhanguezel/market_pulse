...
import {
  ...
  Briefcase, Users, PieChart, User, Menu, X, Plus, Loader2, PanelLeftClose, PanelLeft, Bell, Lock, HardDrive, Settings,
} from 'lucide-react';
...
const ICONS: Record<string, React.ComponentType<{ className?: string }>> = {
  LayoutDashboard, Target, Building2, TrendingUp, FileText, ShoppingCart,
  Package, Folder, CalendarCheck, CalendarDays, ListChecks, BellRing, Mail, Radar, BarChart3,
  Briefcase, Users, PieChart, User, HardDrive, Bell, Settings,
};
