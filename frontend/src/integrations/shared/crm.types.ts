...
export type CrmActivity = { id: string; type?: string | null; subject?: string | null; body?: string | null; planned_start_at?: string | null; due_at?: string | null; done?: number | boolean; ref_type?: string | null; ref_id?: string | null; related_name?: string | null; owner_name?: string | null; created_at?: string };
