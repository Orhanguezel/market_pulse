...
export default function ClientLayout({
  ...
  const isAppPath = /^\/[^/]+\/(dashboard|amazon|firma-bulucu|musteriler|satis-firsatlari|aktiviteler|kontaklar|potansiyel-musteriler|teklifler|siparisler|urunler|belgeler|gorevler|takvim|hatirlatmalar|karar-vericiler|mail-yonetimi|isletme-yonetimi|kullanicilar|raporlar|bildirimler|me\/settings)(\/|$)/.test(pathname || '');
